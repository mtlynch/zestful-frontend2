...
<div class="card-deck use-cases">
  ...
  <div class="card shadow-sm text-center">
    <img
      class="card-img-top"
      src="/images/shopping-cart-icon.gif"
...
Zestful licenses its data with [developer-friendly terms](/terms-of-service/):
...
> **copy or store the information it provides**, including any derived,
> hashed, or transformed data... If you stop using the spoonacular API or
> if your access to the API is suspended for any reason, then you must delete
> all data you ever obtained from the spoonacular API.

-Spoonacular's [Terms of Service](https://spoonacular.com/food-api/terms)

> You are prohibited from **copying or archiving** any of Edamam Content and/or
> collecting any data from Edamam Content, without Edamam’s prior written
> consent... In the event this agreement between you and Edamam under these
> Terms is terminated for any reason... you shall forthwith and permanently
> delete all Edamam Content which you used and/or stored/archived in connection
> with your use of the Edamam API.

-Edamam's [Terms of Service](https://developer.edamam.com/about/terms)

## Contact

Questions? Please reach out to
[michael@zestfuldata.com](mailto:michael@zestfuldata.com), and I'll be happy to
assist you.
